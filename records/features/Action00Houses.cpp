...
const std::map<std::string, uint16_t> g_indices =
{
    ...
    { str_tile_acceptance_list,    0x23'00 },
};
...
constexpr UInt8Descriptor              desc_0E  = { 0x0E, str_mail_acceptance,        PropFormat::Hex };
constexpr UInt8Descriptor              desc_0F  = { 0x0F, str_goods_etc_acceptance,   PropFormat::Hex };
constexpr UInt16Descriptor             desc_10  = { 0x10, str_la_rating_decrease,     PropFormat::Hex };
constexpr UInt8Descriptor              desc_11  = { 0x11, str_removal_cost_multiplier,PropFormat::Hex };
constexpr UInt16Descriptor             desc_12  = { 0x12, str_building_name_id,       PropFormat::Hex };
constexpr UInt16Descriptor             desc_13  = { 0x13, str_availability_mask,      PropFormat::Hex };
constexpr UInt8Descriptor              desc_14  = { 0x14, str_callback_flags,         PropFormat::Hex };
constexpr UInt8Descriptor              desc_15  = { 0x15, str_override_byte,          PropFormat::Hex };
constexpr UInt8Descriptor              desc_16  = { 0x16, str_refresh_multiplier,     PropFormat::Hex };
constexpr UInt8ArrayDescriptor4        desc_17  = { 0x17, str_four_random_colours,    PropFormat::Hex };
constexpr UInt8Descriptor              desc_18  = { 0x18, str_appearance_probability, PropFormat::Hex };
constexpr UInt8Descriptor              desc_19  = { 0x19, str_extra_flags,            PropFormat::Hex };
constexpr UInt8Descriptor              desc_1A  = { 0x1A, str_animation_frames,       PropFormat::Hex };
constexpr UInt8Descriptor              desc_1B  = { 0x1B, str_animation_speed,        PropFormat::Hex };
constexpr UInt8Descriptor              desc_1C  = { 0x1C, str_building_class,         PropFormat::Hex };
constexpr UInt8Descriptor              desc_1D  = { 0x1D, str_callback_flags_2,       PropFormat::Hex };
...
bool Action00Houses::parse_property(TokenStream& is, const std::string& name, uint8_t& property)
{
    ...
    if (it != g_indices.end())
    {
        ...
        switch (index)
        {
            ...
            case 0x0A'00: desc_0A.parse(m_0A_years_available, is);         break;
            ...
            case 0x0F'00: desc_0F.parse(m_0F_goods_etc_acceptance, is);    break;

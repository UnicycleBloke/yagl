...
constexpr IntegerDescriptorT<uint8_t>  desc_0F  = { 0x0F, str_goods_etc_acceptance,   PropFormat::Hex };
...
constexpr IntegerDescriptorT<uint8_t>  desc_1A  = { 0x1A, str_animation_frames,       PropFormat::Hex };
...
bool Action00Houses::read_property(std::istream& is, uint8_t property)
{
    switch (property)
    {
        ...
        case 0x0F: m_0F_goods_etc_acceptance    = read_uint8(is); break;
        ...
        case 0x1A: m_1A_animation_frames        = read_uint8(is); break;
...
bool Action00Houses::write_property(std::ostream& os, uint8_t property) const
{
    switch (property)
    {
        ...
        case 0x0F: write_uint8(os, m_0F_goods_etc_acceptance); break;
        ...
        case 0x1A: write_uint8(os, m_1A_animation_frames); break;

...
constexpr UInt8Descriptor     desc_08  = { 0x08, str_speed_2_kmh,                  PropFormat::Hex };
constexpr UInt8Descriptor     desc_09  = { 0x09, str_running_cost_factor,          PropFormat::Hex };
constexpr UInt32Descriptor    desc_0A  = { 0x0A, str_running_cost_base,            PropFormat::Hex };
constexpr UInt8Descriptor     desc_0E  = { 0x0E, str_sprite_id,                    PropFormat::Hex };
constexpr UInt8Descriptor     desc_0F  = { 0x0F, str_cargo_capacity,               PropFormat::Hex };
constexpr UInt8Descriptor     desc_10  = { 0x10, str_cargo_type,                   PropFormat::Hex };
constexpr UInt8Descriptor     desc_11  = { 0x11, str_cost_factor,                  PropFormat::Hex };
constexpr UInt8Descriptor     desc_12  = { 0x12, str_sound_effect_type,            PropFormat::Hex };
constexpr UInt8Descriptor     desc_13  = { 0x13, str_power_10_hp,                  PropFormat::Hex };
constexpr UInt8Descriptor     desc_14  = { 0x14, str_weight_quarter_tons,          PropFormat::Hex };
constexpr UInt8Descriptor     desc_15  = { 0x15, str_speed_half_kmh,               PropFormat::Hex };
constexpr UInt32Descriptor    desc_16  = { 0x16, str_refit_cargo_types,            PropFormat::Hex };
constexpr UInt8Descriptor     desc_17  = { 0x17, str_callback_flags_mask,          PropFormat::Hex };
constexpr UInt8Descriptor     desc_18  = { 0x18, str_coeff_of_tractive_effort,     PropFormat::Hex };
constexpr UInt8Descriptor     desc_19  = { 0x19, str_coeff_of_air_drag,            PropFormat::Hex };
constexpr UInt8Descriptor     desc_1A  = { 0x1A, str_refit_cost,                   PropFormat::Hex };
constexpr UInt8Descriptor     desc_1B  = { 0x1B, str_retire_vehicle_early,         PropFormat::Hex };
constexpr UInt8Descriptor     desc_1C  = { 0x1C, str_miscellaneous_flags,          PropFormat::Hex };
constexpr UInt16Descriptor    desc_1D  = { 0x1D, str_refittable_cargo_classes,     PropFormat::Hex };
constexpr UInt16Descriptor    desc_1E  = { 0x1E, str_non_refittable_cargo_classes, PropFormat::Hex };
constexpr LongDateDescriptor  desc_1F  = { 0x1F, str_long_introduction_date };
constexpr UInt8ExtDescriptor  desc_20  = { 0x20, str_sort_purchase_list,           PropFormat::Hex };
constexpr UInt8Descriptor     desc_21  = { 0x21, str_visual_effect,                PropFormat::Hex };
constexpr UInt16Descriptor    desc_22  = { 0x22, str_custom_cargo_aging_period,    PropFormat::Hex };
constexpr UInt8Descriptor     desc_23  = { 0x23, str_shorten_vehicle,              PropFormat::Hex };

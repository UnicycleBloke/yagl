...
constexpr IntegerDescriptorT<uint16_t> desc_0A  = { 0x0A, str_tile_acceptance1,       PropFormat::Hex };
constexpr IntegerDescriptorT<uint16_t> desc_0B  = { 0x0B, str_tile_acceptance2,       PropFormat::Hex };
constexpr IntegerDescriptorT<uint16_t> desc_0C  = { 0x0C, str_tile_acceptance3,       PropFormat::Hex };
...
bool Action00IndustryTiles::read_property(std::istream& is, uint8_t property)
{
    switch (property)
    {
        ...
        case 0x0A: m_0A_tile_acceptance1       = read_uint16(is); break;
        case 0x0B: m_0B_tile_acceptance2       = read_uint16(is); break;
        case 0x0C: m_0C_tile_acceptance3       = read_uint16(is); break;
...
bool Action00IndustryTiles::write_property(std::ostream& os, uint8_t property) const
{
    switch (property)
    {
        ...
        case 0x0A: write_uint16(os, m_0A_tile_acceptance1); break;
        case 0x0B: write_uint16(os, m_0B_tile_acceptance2); break;
        case 0x0C: write_uint16(os, m_0C_tile_acceptance3); break;

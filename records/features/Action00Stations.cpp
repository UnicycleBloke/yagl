...
constexpr const char* str_advanced_sprite_layout    = "advanced_sprite_layout";
...
const std::map<std::string, uint8_t> g_indices =
{
    ...
    { str_advanced_sprite_layout,    0x1A }, 
    { str_minimum_bridge_height,     0x1B }, 
    { str_station_name_id,           0x1C }, 
    { str_station_class_name_id,     0x1D }, 
};

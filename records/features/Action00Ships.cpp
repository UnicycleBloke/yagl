...
constexpr UInt8Descriptor       desc_0A  = { 0x0A, str_cost_factor,                  PropFormat::Hex };
constexpr UInt8Descriptor       desc_0B  = { 0x0B, str_speed_2_kmh,                  PropFormat::Hex };
constexpr UInt8Descriptor       desc_0C  = { 0x0C, str_cargo_type,                   PropFormat::Hex };
constexpr UInt16Descriptor      desc_0D  = { 0x0D, str_cargo_capacity,               PropFormat::Hex };
constexpr UInt8Descriptor       desc_0F  = { 0x0F, str_running_cost_factor,          PropFormat::Hex };
constexpr UInt8Descriptor       desc_10  = { 0x10, str_sound_effect_type,            PropFormat::Hex };
constexpr UInt32Descriptor      desc_11  = { 0x11, str_refit_cargo_types,            PropFormat::Hex };
constexpr UInt8Descriptor       desc_12  = { 0x12, str_callback_flags_mask,          PropFormat::Hex };
constexpr UInt8Descriptor       desc_13  = { 0x13, str_refit_cost,                   PropFormat::Hex };
constexpr UInt8Descriptor       desc_14  = { 0x14, str_ocean_speed_fraction,         PropFormat::Hex };
constexpr UInt8Descriptor       desc_15  = { 0x15, str_canal_speed_fraction,         PropFormat::Hex };
...
constexpr UInt8Descriptor       desc_1C  = { 0x1C, str_visual_effect,                PropFormat::Hex };
constexpr UInt16Descriptor      desc_1D  = { 0x1D, str_custom_cargo_aging_period,    PropFormat::Hex };

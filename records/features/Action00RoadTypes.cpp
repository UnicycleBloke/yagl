...
constexpr const char* str_powered_roadtypes       = "powered_roadtypes";
...
const std::map<std::string, uint8_t> g_indices =
{
    ...
    { str_powered_roadtypes,       0x0F },
    { str_roadtype_flags,          0x10 },
    { str_construction_costs,      0x13 },
    { str_speed_limit,             0x14 },
    { str_minimap_colour,          0x16 },
    { str_introduction_date,       0x17 },
    { str_required_roadtypes,      0x18 },
    { str_introduced_roadtypes,    0x19 },
    { str_sort_order,              0x1A },
    { str_road_type_name_id,       0x1B },
    { str_maintenance_cost_factor, 0x1C },
    { str_alternate_roadtypes,     0x1D },
};
...
constexpr GRFLabelListDescriptor   desc_0F = { 0x0F, str_powered_roadtypes };
constexpr UInt8Descriptor          desc_10 = { 0x10, str_roadtype_flags,          UIntFormat::Hex };
...
constexpr UInt16Descriptor         desc_1B = { 0x1B, str_road_type_name_id,       UIntFormat::Hex };
...
bool Action00RoadTypes::read_property(std::istream& is, uint8_t property)
{
    switch (property)
    {
        ...
        case 0x0F: m_0F_powered_roadtypes.read(is);       break;
        case 0x10: m_10_roadtype_flags.read(is);          break;
        ...
        case 0x1B: m_1B_road_type_name_id.read(is);       break;
...
bool Action00RoadTypes::write_property(std::ostream& os, uint8_t property) const
{
    switch (property)
    {
        ...
        case 0x0F: m_0F_powered_roadtypes.write(os);       break;
        case 0x10: m_10_roadtype_flags.write(os);          break;
        ...
        case 0x1B: m_1B_road_type_name_id.write(os);       break;
...
bool Action00RoadTypes::print_property(std::ostream& os, uint8_t property, uint16_t indent) const 
{
    switch (property)
    {
        ...
        case 0x0F: desc_0F.print(m_0F_powered_roadtypes, os, indent);       break;
...
bool Action00RoadTypes::parse_property(TokenStream& is, const std::string& name, uint8_t& property)
{
    ...
    if (it != g_indices.end())
    {
        ...
        switch (property)
        {
            case 0x08: desc_08.parse(m_08_roadtype_label, is);          break;
            ...
            case 0x0F: desc_0F.parse(m_0F_powered_roadtypes, is);       break;
            case 0x10: desc_10.parse(m_10_roadtype_flags, is);          break;
            ...
            case 0x18: desc_18.parse(m_18_required_roadtypes, is);      break;
            case 0x19: desc_19.parse(m_19_introduced_roadtypes, is);    break;
            case 0x1A: desc_1A.parse(m_1A_sort_order, is);              break;
            case 0x1B: desc_1B.parse(m_1B_road_type_name_id, is);       break;
            case 0x1C: desc_1C.parse(m_1C_maintenance_cost_factor, is); break;
            case 0x1D: desc_1D.parse(m_1D_alternate_roadtypes, is);     break;
            default:   throw PROPERTY_ERROR("Unknown property", property);
        }

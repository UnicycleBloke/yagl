...
constexpr UInt8Descriptor          desc_10 = { 0x10, str_roadtype_flags,          PropFormat::Hex };
...
constexpr UInt16Descriptor         desc_1B = { 0x1B, str_road_type_name_id,       PropFormat::Hex };
...
bool Action00RoadTypes::parse_property(TokenStream& is, const std::string& name, uint8_t& property)
{
    ...
    if (it != g_indices.end())
    {
        ...
        switch (property)
        {
            ...
            case 0x0F: desc_0F.parse(m_0F_compatible_roadtypes, is);    break;

...
{
public:
    explicit LexerError(const std::string& what_arg, uint32_t yagl_line, uint32_t yagl_column, 
        const char* code_file, uint32_t code_line);
    explicit LexerError(const char* what_arg, uint32_t yagl_line, uint32_t yagl_column, 
        const char* code_file, uint32_t code_line);
